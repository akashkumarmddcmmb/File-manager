...
export const initialFolders: FolderItem[] = [
  ...
  // SD Card & External Storage Folders
  ...
  { id: 'f-sd-music-bollywood', name: 'Bollywood', path: '/Music/Bollywood', parentPath: '/Music', storageDevice: 'sdcard', createdAt: '2026-01-03' },
  { id: 'f-sd-music-dj', name: 'DJ_Mix', path: '/Music/DJ_Mix', parentPath: '/Music', storageDevice: 'sdcard', createdAt: '2026-01-03' },
  { id: 'f-sd-music-oldies', name: 'Oldies', path: '/Music/Oldies', parentPath: '/Music', storageDevice: 'sdcard', createdAt: '2026-01-03' },
  { id: 'f-sd-audio-bhakti', name: 'Bhakti', path: '/Audio/Bhakti', parentPath: '/Audio', storageDevice: 'sdcard', createdAt: '2026-01-03' },
  { id: 'f-sd-download', name: 'Download', path: '/Download', parentPath: '/', storageDevice: 'sdcard', createdAt: '2026-01-03' },
...
export const initialFiles: FileItem[] = [
  ...
  {
    id: 'aud-int-0a',
    name: 'Kitni Hasrat Hain Humein _ Sanu & Sadhana.mp3',
    size: 5800000, // 5.8 MB
    type: 'audio',
    mimeType: 'audio/mpeg',
    folder: '/Music/Bollywood',
    storageDevice: 'internal',
    artist: 'Kumar Sanu, Sadhana Sargam',
    album: 'Saajan / 90s Romantic Hits',
  ...
  {
    id: 'aud-int-0b',
    name: 'Saiyan Se Chhup Ke(MP3_160K).mp3',
    size: 4900000, // 4.9 MB
    type: 'audio',
    mimeType: 'audio/mpeg',
    folder: '/Download',
  ...
  {
    id: 'aud-int-6',
    name: 'Tum_Hi_Ho_Aashiqui_2.mp3',
    size: 10200000, // 10.2 MB
    type: 'audio',
    mimeType: 'audio/mpeg',
    folder: '/Music/Bollywood',
    storageDevice: 'internal',
    ...
    url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3',
    thumbnail: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=300&auto=format&fit=crop&q=60',
    artist: 'Arijit Singh',
    album: 'Aashiqui 2',
    isStarred: true,
  },
  {
    id: 'aud-int-7',
    name: 'WhatsApp_Audio_Family_Song.mp3',
    size: 5100000, // 5.1 MB
    type: 'audio',
    mimeType: 'audio/mpeg',
    folder: '/WhatsApp/Media/WhatsApp Audio',
    ...
    url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3',
    thumbnail: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=300&auto=format&fit=crop&q=60',
    artist: 'WhatsApp Voice & Audio',
    album: 'WhatsApp Received Audio',
  },
  {
    id: 'aud-int-8',
    name: 'FM_Radio_Recording_Evening.m4a',
    size: 6400000, // 6.4 MB
    type: 'audio',
    mimeType: 'audio/mp4',
    folder: '/Recordings',
    ...
    updatedAt: '2026-08-18T21:40:00Z',
    url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3',
    thumbnail: 'https://images.unsplash.com/photo-1590602847861-f357a9332bbc?w=300&auto=format&fit=crop&q=60',
    artist: 'Radio Mirchi 98.3 FM',
    album: 'Live Radio Capture',
  },
  ...
  {
    id: 'aud-sd-7',
    name: 'Bhojpuri_Superhit_DJ_Nonstop_Mix.mp3',
    size: 16800000, // 16.8 MB
    type: 'audio',
    mimeType: 'audio/mpeg',
    folder: '/Music/DJ_Mix',
    storageDevice: 'sdcard',
    ...
    artist: 'DJ Akash Mix',
    album: 'Desi Dhamaka 2026',
    isStarred: true,
  },
  {
    id: 'aud-sd-8',
    name: 'Punjabi_Dhol_Beats_Bhangra.mp3',
    size: 10400000, // 10.4 MB
    type: 'audio',
    mimeType: 'audio/mpeg',
    folder: '/Download',
    storageDevice: 'sdcard',
  ...
  {
    id: 'aud-sd-9',
    name: 'Sufi_Qawwali_Nusrat_Collection.mp3',
    ...
    updatedAt: '2026-06-20T19:40:00Z',
    url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3',
    thumbnail: 'https://images.unsplash.com/photo-1507838153414-b4b713384a76?w=300&auto=format&fit=crop&q=60',
    artist: 'Nusrat Fateh Ali Khan',
    album: 'Sufiana Nights',
    isStarred: true,
  },
  {
    id: 'aud-sd-10',
    name: 'Call_Recording_Important_Discussion.m4a',
    size: 4200000, // 4.2 MB
    type: 'audio',
    mimeType: 'audio/mp4',
    folder: '/Recordings',
    ...
    thumbnail: 'https://images.unsplash.com/photo-1516280440614-37939bbacd81?w=300&auto=format&fit=crop&q=60',
    artist: 'Phone Voice Recorder',
    album: 'Call Recordings',
  },
  {
    id: 'aud-sd-11',
    name: 'MicroSD_Bollywood_Romantic_Mashup.mp3',
    ...
    updatedAt: '2026-07-29T17:20:00Z',
    url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3',
    thumbnail: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=300&auto=format&fit=crop&q=60',
    artist: 'Arijit Singh, Shreya Ghoshal',
    album: 'Bollywood Love Hits',
    isStarred: true,
  },
  {
    id: 'aud-sd-12',
    name: 'Ghazal_Pankaj_Udhas_Live.opus',
    size: 8400000, // 8.4 MB
    type: 'audio',
    mimeType: 'audio/ogg',
    folder: '/Music/Oldies',
    ...
    updatedAt: '2026-06-12T20:10:00Z',
    url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3',
    thumbnail: 'https://images.unsplash.com/photo-1487180144351-b8472da7d491?w=300&auto=format&fit=crop&q=60',
    artist: 'Pankaj Udhas',
    album: 'Mehfil Live Ghazals',
  },
